      ...
      <section id="buttons" className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {buttonExamples.map((example) => (
            <div key={example.code} className="bg-muted/40 flex flex-col gap-3 rounded-md border p-4">
              ...
              <div className="flex flex-col gap-2">
                <p className="text-sm font-medium">
                  <span className="text-muted-foreground">Component:</span> {example.name}
                </p>
                <p className="text-sm">
                  <span className="text-muted-foreground">Variant:</span>{" "}
                  <code className="bg-muted rounded px-1 py-0.5 text-xs">{example.variant}</code>
                  {" · "}
                  <span className="text-muted-foreground">Size:</span>{" "}
                  <code className="bg-muted rounded px-1 py-0.5 text-xs">{example.size}</code>
                </p>
