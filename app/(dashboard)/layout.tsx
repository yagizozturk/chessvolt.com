...
import { ImportedGamesProvider } from "@/features/analysis/components/imported-games-provider";
  ...
  return (
    <SidebarProvider open={false}>
      ...
      */}
        ...
        (study first visit after onboarding) or by sidebar "How Volt Works" (any time). 
      */}
        <VoltExplainDialog />
      </ImportedGamesProvider>
    </SidebarProvider>
