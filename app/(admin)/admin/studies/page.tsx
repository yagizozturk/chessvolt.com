...
const STUDY_ADMIN_ERRORS: Record<string, string> = {
  ...
  delete_failed: "Could not delete the study. Please try again.",
};
    ...
    <div className="container mx-auto max-w-6xl space-y-8 px-4 py-8">
      ...
      <section>
        <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-xl font-bold tracking-tight">Studies</h2>
            <p className="text-muted-foreground text-sm">{studies.length} studies</p>
          </div>
