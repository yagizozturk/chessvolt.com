...
import { getAllContentThemesWithTheme } from "@/features/content-theme/services/content-theme.service";
...
export default async function AdminContentThemesPage({ searchParams }: Props) {
  ...
  const items = await getAllContentThemesWithTheme(supabase);
    ...
    <div className="container mx-auto max-w-6xl space-y-8 px-4 py-8">
      ...
      <section>
        <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-xl font-bold tracking-tight">Content themes</h2>
