...
export function PuzzleMetadataFields({
  studies,
  defaultStudyId = "",
  defaultTitle = "",
  defaultRating = null,
  ...
  return (
    <FieldGroup>
      ...
      <Field>
        ...
        <Input name="title" required defaultValue={defaultTitle} placeholder="Puzzle title" />
      </Field>
      <Field>
      ...
      <Field>
        ...
        <textarea
          ...
          placeholder='{"mainIdea":"...","lessonsLearned":"...","plys":[{"ply":1,"move":"e2e4","title":"...","visuals":[],"strategy":"...","takeaway":"...","checkpointMessage":"...","isCompleted":false}]}'
