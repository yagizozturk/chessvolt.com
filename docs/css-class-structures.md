...
— `min-h-svh`: small viewport height; avoids mobile 100vh overflow when browser chrome is visible
...
`container mx-auto max-w-5xl px-4 pt-6 pb-16`

### openings page

`container mx-auto max-w-6xl px-4 pt-6 pb-16`
