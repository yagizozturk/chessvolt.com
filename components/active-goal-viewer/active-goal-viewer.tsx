...
export function ActiveGoalViewer({
  ...
  const descriptionToneClass = isCompleted
  ...
  return (
    ...
    >
      <div role="listitem" aria-current="step">
        <Card
          className={cn("gap-0 overflow-hidden py-0 shadow-md", cardToneClass)}
        >
          <div className="flex flex-row items-start gap-3 px-4 py-4 sm:gap-4 sm:px-5 sm:py-5">
            <div className="flex size-14 shrink-0 items-center justify-center rounded-xl bg-white/25 ring-1 ring-white/20">
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-1 text-left">
              ...
              <CardDescription
                className={cn("text-sm leading-relaxed", descriptionToneClass)}
              >
