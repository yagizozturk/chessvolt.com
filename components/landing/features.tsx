  ...
  const features = [
    {
      ...
      description:
        "Next.js 14 ve Tailwind CSS ile optimize edilmiş, ışık hızında yüklenen arayüzler.",
      icon: <Zap className="text-primary h-10 w-10" />,
    },
    {
      title: "Güvenli Altyapı",
      description:
        "Kurumsal seviyede güvenlik standartları ve modern yetkilendirme çözümleri.",
      icon: <Shield className="text-primary h-10 w-10" />,
    },
    {
      title: "Tam Mobil Uyum",
      description:
        "Tüm ekran boyutlarında kusursuz çalışan, responsive tasarım yaklaşımı.",
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto mt-4 max-w-[700px] md:text-lg">
            Geliştirme sürecinizi hızlandıran ve kullanıcı deneyimini
            önceliklendiren özelliklerle tanışın.
          </p>
        </div>
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="hover:border-primary/50 border-2 transition-all hover:shadow-md"
            >
              <CardHeader>
