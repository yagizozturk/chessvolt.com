...
export const ONBOARDING_STARTER_COLLECTION_2_SLUG = "starter-collection-2";
export const ONBOARDING_STARTER_COLLECTION_2_TITLE = "Starter Collection 2";
...
export const ONBOARDING_RIDDLE_RATING_TOLERANCE = 50;
/** Wider window used when not enough riddles match within the primary tolerance. */
export const ONBOARDING_RIDDLE_RATING_TOLERANCE_FALLBACK = 100;
...
export const ONBOARDING_STARTER_COLLECTION_MIN_RIDDLES = 10;
