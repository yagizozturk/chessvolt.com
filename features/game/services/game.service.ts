...
export async function getGameById(supabase: SupabaseClient, id: string): Promise<Game | null> {
  return gameRepo.findById(supabase, id);
}

export async function getGamesByIds(supabase: SupabaseClient, ids: string[]): Promise<Game[]> {
  return gameRepo.findByIds(supabase, ids);
}

export async function createGame(supabase: SupabaseClient, input: gameRepo.CreateGameInput): Promise<Game | null> {
...
export async function deleteGame(supabase: SupabaseClient, id: string): Promise<boolean> {
