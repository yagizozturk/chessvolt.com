    ...
    <div className={className}>
      <section className="mb-4">
        ...
        <p className="text-muted-foreground text-sm leading-normal">
          By creating an account and using ChessVolt, you agree to be bound by these Terms and Conditions. If you do not
      ...
      <section className="mb-4">
        ...
        <p className="text-muted-foreground text-sm leading-normal">
          ChessVolt provides chess-related tools and content for personal, non-commercial use unless otherwise agreed. You
          agree to use the platform responsibly and in compliance with applicable laws.
        </p>
      </section>
      <section className="mb-4">
      ...
      <section className="mb-4">
        ...
        <p className="text-muted-foreground text-sm leading-normal">
          Your use of ChessVolt is also governed by our Privacy Policy, which describes how we collect, use, and protect
      ...
      <section className="mb-4">
        ...
        <p className="text-muted-foreground text-sm leading-normal">
          ...
          warranties and shall not be liable for any indirect, incidental, or consequential damages arising from your use
          of the service.
        </p>
      </section>
      <section className="mb-4">
        ...
        <p className="text-muted-foreground text-sm leading-normal">
          We may update these Terms and Conditions from time to time. Continued use of ChessVolt after changes are posted
      ...
      <section>
        ...
        <p className="text-muted-foreground text-sm leading-normal">
          If you have questions about these terms, please contact us through the support channels provided on ChessVolt.
        </p>
      </section>
    </div>
  );
